...
#define FLAM_GRASS 0.3
#endif
#define K_LITTER10 1.2       /* 0.97 adapted to grass litter decay now only used for crops and value a middle value of C4 grasses; need to be updated with TRY-database*/
...
[
  /* first pft */
  {
    ...
    "flam" : FLAM_TREE,  /* flam */
    "k_litter10" : { "leaf" : 1.1, "wood" : 0.124 }, /* 0.039K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 1.17, "wood" : 0.124 }*/
    "k_litter10_q10_wood" : 2.75, /* Q10_wood 3*/
    ...
    "nfixpot" : 0.15,  /* Yu and Zhuang 2020 tropical forest*/
...
/*--------------------------------------------------------------------------*/
  {
    "name" : "tropical broadleaved evergreen tree floodtolerant",
    "type" : "tree",
    ...
    {
      "slope" : 1.01,       /* new phenology: slope of cold-temperature limiting function */
      "base" : 10.3,         /* new phenology: inflection point of cold-temperature limiting function (deg C) */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day cold-temperature limiting fct */
    },
    "tmax" :
    {
    ...
    "light" :
    {
      "slope" : 77.17,      /* new phenology: slope of light limiting function */
      "base" : 55.53,       /* new phenology: inflection point of light limiting function (Wm-2) */
      "tau" : 0.8          /* new phenology: change rate of actual to previous day light limiting function */
    },
    "wscal" :
    {
      "slope" : 5.14,       /* new phenology: slope of water limiting function */
      "base": 70,            /* new phenology: inflection point of water limiting function (% water availability)  */
      "tau" : 0.44          /* new phenology: change rate of actual to previous day water limiting function */
    },
    "mort_max" : MORT_MAX,  /* asymptotic maximum mortality rate (1/year) */
    "phenology" : "evergreen",/* phenology */
    ...
    "aprec_min" : APREC_MIN,  /* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,  /* flam */
    "k_litter10" : { "leaf" : 1.1, "wood" : 0.039}, /* 0.039K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 1.17, "wood" : 0.124 }*/
    "k_litter10_q10_wood" : 2.75, /* Q10_wood 3*/
    "vmax_up" : 3,             /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    "cnratio_leaf": {"low": CN_BL_EG_MN, "median" : CN_BL_EG_MD, "high" : CN_BL_EG_MX}, /* 10.7 79.4 cnleaf min max, based on TRY data, prepared by Boris Sakschewski */
    "knstore" : 0.1,       /* knstore, Smith et al. 2014 */
...
/* 2. pft */
  {
    ...
    "aprec_min" : APREC_MIN,/* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 1.17, "wood" : 0.039 }, /* K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 1.17, "wood" : 0.124 },*/
    ...
    "windspeed_dampening" : 0.4,  /* windspeed dampening */
    "roughness_length" : 2.0,  /* roughness length */
    "ist_m" : -0.3,             /* inundation stress threshold [m] */
    "idt_d" : 20.0,             /* inundation duration threshold [days] */
    "irrig_threshold" : { "dry" : IRRIG_THRESHOLD_C3_DRY, "humid" : IRRIG_THRESHOLD_C3_HUMID },
    "leaftype" : "broadleaved",  /* leaftype */
...
/* 3. pft */
  {
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.02,  /* Yu and Zhuang 2020 temperate coniferous forest*/
...
/* 4. pft */
  {
    ...
    "resist" : 0.5,         /* resist 8*/
    "longevity" : 1.6,      /* leaf longevity 10*/
    "sla" : 0.015,         /* specific leaf area 0.01986*/
    "lmro_ratio" : 1.0,     /* lmro_ratio 18*/
    "lmro_offset" : 0.5,     /* lmro_ratio 18*/
    "ramp" : 1000.0,         /* ramp 19*/
    "lai_sapl" : 1.500,     /* lai_sapl 21*/
    ...
    "tmin" :
    {
      ...
      "base" : -7.6297,     /* new phenology: inflection point of cold-temperature limiting function (deg C) */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day cold-temperature limiting fct */
    },
    "tmax" :
    {
    ...
    "light" :
    {
      ...
      "base" : 4,       /* new phenology: inflection point of light limiting function (Wm-2) */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day light limiting function */
    },
    "wscal" :
    {
    ...
    "irrig_threshold" : { "dry" : IRRIG_THRESHOLD_C3_DRY, "humid" : IRRIG_THRESHOLD_C3_HUMID },
    "leaftype" : "broadleaved",/* leaftype */
    "turnover" : {"leaf" : 2.0, "sapwood" : 25.0, "root" : 2.0}, /* turnover leaf  sapwood root 9 11 12*/
    "cn_ratio" : {"leaf" : CTON_LEAF, "sapwood" :  CTON_SAP, "root" : CTON_ROOT}, /* C:N mass ratio for leaf, sapwood, and root 13,14,15*/
    "ratio" : {"sapwood" :  RATIO_SAPW, "root" :  1.16}, /* relative C:N ratio of sapwood and root, Friend et al. 1997, Ecological Modeling, Table 4*/
    "crownarea_max" : 15.0, /* crownarea_max 20*/
    "wood_sapl" : 1.2,      /* sapwood sapling 22*/
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.03,  /* Yu and Zhuang 2020 temperate evergreen forest*/
    "maxbnfcost" : MAXBNFCOSTTE,
    "bnf_cost" : BNF_COST 
  },
/*--------------------------------------------------------------------------*/
/* 5. pft */
  {
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.03,  /* Yu and Zhuang 2020 temperate deciduous forest*/
    "maxbnfcost" : MAXBNFCOSTTE,
    "bnf_cost" : BNF_COST 
  },
/*--------------------------------------------------------------------------*/
/* 6. pft */
  {
    ...
    "nfixing" : true,           /* N fixing in Ma et al., 2022 appraoch */
    "cn" : [30.0, 55.0, 70.0, 77.0], /* curve number */
    "beta_root" : 0.95,    /* beta_root original 0.943*/
    "minwscal" : 0.00,      /* minwscal 3*/
    "gmin"  : 0.8,          /* gmin 4*/
    "respcoeff" : 1.2,      /* respcoeff 5*/
    "nmax" : 100.0,          /* nmax 7*/
    ...
    "tmin" :
    {
      "slope" : 0.21008,     /* new phenology: slope of cold-temperature limiting function */
    ...
    "aprec_min" : APREC_MIN,/* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 0.76, "wood" : 0.041 }, /* K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 0.95, "wood" : 0.104 }*/
    "k_litter10_q10_wood" : 1.37, /* Q10_wood */
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.042,  /* Yu and Zhuang 2020 boreal forest*/
...
/* 7. pft */
  {
    ...
    "resist" : 0.12,         /* resist 8*/
    "longevity" : 0.5,      /* leaf longevity 10*/
    "sla" : 0.021,          /* specific leaf area 0.03233*/
    "lmro_ratio" : 1.0,     /* lmro_ratio 18*/
    "lmro_offset" : 0.5,     /* lmro_ratio 18*/
    "ramp" : 200.0,          /* ramp 19*/
    "lai_sapl" : 1.500,     /* lai_sapl 21*/
    ...
    {
      "slope" : 58,         /* new phenology: slope of light limiting function */
      "base" : 39.78,       /* new phenology: inflection point of light limiting function (Wm-2) */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day light limiting function */
    },
    "wscal" :
    {
      "slope" : 5.24,       /* new phenology: slope of water limiting function */
      "base" : 2,           /* new phenology: inflection point of water limiting function (% water availability)   20.96*/
      "tau" : 0.7           /* new phenology: change rate of actual to previous day water limiting function */
    },
    "mort_max" : MORT_MAX,  /* asymptotic maximum mortality rate (1/year) */
    "phenology" : "summergreen",/* phenology */
    ...
    "aprec_min" : APREC_MIN,/* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 0.76, "wood" : 0.041 }, /* K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 1.2, "wood" : 0.104 }*/
    "k_litter10_q10_wood" : 1.37, /* Q10_wood 1.62*/
    "vmax_up" : 3.8,              /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    "cnratio_leaf": {"low": CN_BL_DC_MN, "median": CN_BL_DC_MD, "high" : CN_BL_DC_MX}, /* 10.7 79.4 cnleaf min max, based on TRY data, prepared by Boris Sakschewski */
...
/* 8. pft */
  {
    ...
    "nfixing" : true,           /* N fixing in Ma et al., 2022 appraoch */
    "cn" : [30.0, 55.0, 70.0, 77.0], /* curve number */
    "beta_root" : 0.943,     /* beta_root original 0.943*/
    "minwscal" : 0.00,      /* minwscal 3*/
    "gmin"  : 0.8,          /* gmin 4*/
    ...
    "sla" : 0.012,          /* specific leaf area 0.02118*/
    "lmro_ratio" : 0.8,     /* 1 lmro_ratio 18*/
    "lmro_offset" : 0.5,     /* lmro_ratio 18*/
    "ramp" : 200.0,          /* ramp 19*/
    "lai_sapl" : 1.500,     /* lai_sapl 21*/
    "gdd5min" : 350.0,      /* gdd5min 30*/
    "twmax" : 25.0,          /* twmax 31*/
    "twmax_daily" : 27.0,    /* twmax_daily 31*/
    "gddbase" : 5.0,        /* gddbase (deg C) 33*/
    ...
    "tmin" :
    {
      "slope" : 0.13,       /* new phenology: slope of cold-temperature limiting function 0.15 */
      "base" : -12.79,      /* new phenology: inflection point of cold-temperature limiting function (deg C) -4.165*/
      "tau" : 0.2           /* new phenology: change rate of actual to previous day cold-temperature limiting fct */
    },
    "tmax" :
    {
      "slope" : 0.8,        /* new phenology: slope of warm-temperature limiting function tmax_sl 0.24*/
      "base" : 36.12,         /* new phenology: inflection point of warm-temperature limiting function (deg C) */
      "tau" : 0.2            /* new phenology: change rate of actual to previous day warm-temperature limiting fct */
    },
    "light" :
    {
      "slope" : 23,          /* new phenology: slope of light limiting function 95 */
      "base" : 50,        /* new phenology: inflection point of light limiting function (Wm-2)130.1  */
    ...
    "wscal" :
    {
      ...
      "tau" : 0.98            /* new phenology: change rate of actual to previous day water limiting function */
    },
    "mort_max" : MORT_MAX,  /* asymptotic maximum mortality rate (1/year) */
    "phenology" : "summergreen",/* phenology */
    "path" : "C3",            /* pathway */
    ...
    "b":  BC3, /* leaf respiration as fraction of Vmax for C3 plants */
    "temp" : { "low" : -1000, "high" : -7.4 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.30670,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : 0.0000667, /* scaling factor nesterov fire danger index */
    "vpd_par" : 6, /*scaling factor vpd fire danger index*/
    "fuelbulkdensity" : 22.0, /* fuel bulk density */
    ...
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 0.76, "wood" : 0.041 }, /* K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 0.95, "wood" : 0.104 }*/
    "k_litter10_q10_wood" : 1.37, /* Q10_wood 2.22*/
    "vmax_up" : 4.8,              /* 2.8 vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    ...
    "irrig_threshold" : { "dry" : IRRIG_THRESHOLD_C3_DRY, "humid" : IRRIG_THRESHOLD_C3_HUMID },
    "leaftype" : "needleleaved",/* leaftype */
    "turnover" : {"leaf" : 1.0, "sapwood" : 25.0, "root" : 2.0}, /* turnover leaf  sapwood root 9 11 12*/
    "cn_ratio" : {"leaf" : CTON_LEAF, "sapwood" :  CTON_SAP, "root" : CTON_ROOT}, /* C:N mass ratio for leaf, sapwood, and root 13,14,15*/
    "ratio" : {"sapwood" :  RATIO_SAPW, "root" :  1.16}, /* relative C:N ratio of sapwood and root, Friend et al. 1997, Ecological Modeling, Table 4*/
    "crownarea_max" : 20.0, /* crownarea_max 20*/
    "wood_sapl" : 1.2,      /* sapwood sapling 22*/
...
/* 9. pft */
  {
    ...
    "k_litter10" : { "leaf" : 1.2, "wood" : 0.97 }, /* K_LITTER10 turnover rate after Brovkin etal 2012{ "leaf" : 1.2, "wood" : 0.97 }*/
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.015,  /* Yu and Zhuang 2020 grassland*/
    "maxbnfcost" : MAXBNFCOSTGR,
    "bnf_cost" : BNF_COST 
  },
/*--------------------------------------------------------------------------*/
/* 10. pft */
  {
    ...
    "wscal" :
    {
      ...
      "base" : 30.07,       /* new phenology: inflection point of water limiting function (% water availability)  */
    ...
    "aprec_min" : 100,       /* minimum annual precipitation to establish */
    "flam" : FLAM_GRASS,     /* flam */
    "k_litter10" : { "leaf" : 1.1, "wood" : 1.2 }, /* K_LITTER10 turnover rate after Brovkin etal 2012*/
    "k_litter10_q10_wood" : 1.0, /* Q10_wood */
    "vmax_up" : 4.51,             /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.19,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    ...
    "reprod_cost" : REPROD_COST, /* reproduction cost */
    "temp_bnf_lim" : {"low" : TEMP_BNF_MIN, "high" : TEMP_BNF_MAX},
    "temp_bnf_opt" : {"low" : 16, "high" : 35},  /* Yu and Zhuang 2020 grassland*/
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.015,  /* Yu and Zhuang 2020 grassland*/
    "maxbnfcost" : MAXBNFCOSTGR,
...
/* 11. pft */
  {
    ...
    "resist" : 0.01,        /* resist 8*/
    "longevity" : 0.35,     /* leaf longevity 10*/
    "sla" : 0.045242,        /* specific leaf area */
    "lmro_ratio" : 0.6,     /* lmro_ratio 18*/
    "lmro_offset" : 0.5,     /* lmro_ratio 18*/
    "ramp" : 100.0,          /* ramp 19*/
    "lai_sapl" : 0.001,     /* lai_sapl 21*/
    ...
    {
      "slope" : 0.88,       /* new phenology: slope of water limiting function */
      "base" : 2,           /* new phenology: inflection point of water limiting function (% water availability)  */
    ...
    "temp_photos" : { "low" : 10.0, "high" : 25. },/* lower and upper limit of temperature optimum for photosynthesis(deg C) 25 26*/
    "b":  BC3, /* leaf respiration as fraction of Vmax for C3 plants */
    "temp" : { "low" : -1000.0, "high" : -7.4 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.30184,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : 0.0000667, /* scaling factor nesterov fire danger index */
    "vpd_par" : 6, /*scaling factor vpd fire danger index*/
    "fuelbulkdensity" : 4.0, /* fuel bulk density */
...
/* 12. pft */
  {
    ...
    "wscal" :
    {
      "slope" : 8,       /* new phenology: slope of water limiting function */
      "base" : 50,           /* new phenology: inflection point of water limiting function (% water availability)  */
      "tau" : 0.4          /* new phenology: change rate of actual to previous day water limiting function */
    },
    "mort_max" : MORT_MAX_GRASS,  /* asymptotic maximum mortality rate (1/year) */
    "phenology" : "any",      /* phenology */
    "path" : "C3",            /* pathway */
...
/* 13. pft */
  {
    ...
    "reprod_cost" : REPROD_COST, /* reproduction cost */
    "temp_bnf_lim" : {"low" : TEMP_BNF_MIN, "high" : TEMP_BNF_MAX},
    "temp_bnf_opt" : {"low" : 12, "high" : 30},  /* Yu and Zhuang 2020 grassland*/
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.01,  /* Yu and Zhuang 2020 grassland*/
    "maxbnfcost" : MAXBNFCOSTGR,
    "bnf_cost" : BNF_COST 
  },
...
/* 1. bft */
  {
    ...
    "aprec_min" : APREC_MIN,/* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 0.93, "wood" : 0.124 }, /* K_LITTER10 turnover rate after Brovkin etal 2012*/
    "k_litter10_q10_wood" : 2.75, /* Q10_wood */
    "vmax_up" : 2.8,              /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},     
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],     
    "nfixpot" : 0.015,  /* Yu and Zhuang 2020 minimum*/     
    "maxbnfcost" : MAXBNFCOSTTR,   
    "bnf_cost" : BNF_COST, 
    "rotation" : 8,         /* rotation */
...
/* 2. bft */
  {
    ...
    "aprec_min" : APREC_MIN,/* minimum annual precipitation to establish */
    "flam" : FLAM_TREE,     /* flam */
    "k_litter10" : { "leaf" : 0.95, "wood" : 0.041 }, /* K_LITTER10 turnover rate after Brovkin etal 2012*/
    "k_litter10_q10_wood" : 1.37, /* Q10_wood */
    "vmax_up" : 2.8,              /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    ...
    "swc_bnf" : {"low" : SWC_BNF_LOW, "high" : SWC_BNF_HIGH},
    "phi_bnf" : [PHI_BNF_1, PHI_BNF_2],
    "nfixpot" : 0.015,  /* Yu and Zhuang 2020 temperate deciduous forest*/
    "maxbnfcost" : MAXBNFCOSTTE,
    "bnf_cost" : BNF_COST 
  },
/*--------------------------------------------------------------------------*/
...
/* 2. cft */
  {
    ...
    "k_litter10" : { "leaf" : K_LITTER10, "wood" : K_LITTER10}, /* K_LITTER10 turnover rate after Brovkin etal 2012*/
    "k_litter10_q10_wood" : 1, /* Q10_wood */
    "ist_m" : 0.5,                /* inundation stress threshold [m] */
    "idt_d" : 100.0,              /* inundation duration threshold [days] */
    "vmax_up" : 5.51,             /* vmax_up, Maximum N uptake capacity per unit fine root mass, Smith et al. 2014 */
    "kNmin": 0.05,                /* kNmin, Rate of N uptake not associated with Michaelis-Menten Kinetics, Zaehle&Friend 2000 */
    "KNmin" : 1.48,               /* KNmin, Half saturation concentration of fine root N uptake, Smith et al. 2014 */
    "cnratio_leaf": {"low": 14.3, "median" : CN_CROPS_MEAN, "high" : 58.8},  /* cnleaf min max, White et al. 2000 doi: 10.1175/1087-3562(2000)004<0003:PASAOT>2.0.CO;2*/
...
/* 5. cft */
  {
    ...
    "nfixpot" : 0.055,  /* Yu and Zhuang 2020 grassland*/
