...
/**                      p  f  t  _  n  o  n  .  j  s                              \n**/
/**                                                                                \n**/
/**  PFT and CFT parameter file for LPJmL version 5.1.001 without nitrogen         \n**/
...
#define ALPHAA 0.4  /* alphaa for simulations with nitrogen limitation */
...
[
  /* first pft */
  {
    ...
    "emax": 7.,            /* emax 35*/
    "intc" : 0.02,          /* intc 36*/
    "alphaa" : ALPHAA, /* alphaa, fraction of PAR assimilated at ecosystem level, relative to leaf level */
    ...
    "bc" : BC3,        /*leaf respiration as fraction of Vmax for C3 plants */
...
/* 5. pft */
  {
    ...
    "tmin" :
    {
      ...
      "base" : 13.69,        /* new phenology: inflection point of cold-temperature limiting function (deg C), originally 13.69 from Forkel etal. */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day cold-temperature limiting fct */
    },
    "tmax" :
    {
...
/* 8. pft */
  {
    ...
    "tmin" :
    {
      "slope" : 0.15,       /* new phenology: slope of cold-temperature limiting function 0.15 */
      "base" : -4.165,      /* new phenology: inflection point of cold-temperature limiting function (deg C) */
      "tau" : 0.2           /* new phenology: change rate of actual to previous day cold-temperature limiting fct */
    },
    "tmax" :
    {
      "slope" : 0.24,        /* new phenology: slope of warm-temperature limiting function tmax_sl 0.24*/
      "base" : 44.6,         /* new phenology: inflection point of warm-temperature limiting function (deg C) */
      "tau" : 0.2            /* new phenology: change rate of actual to previous day warm-temperature limiting fct */
    },
    "light" :
    {
      "slope" : 95,          /* new phenology: slope of light limiting function 95 */
      "base" : 130.1,        /* new phenology: inflection point of light limiting function (Wm-2)130.1  */
      "tau" : 0.2            /* new phenology: change rate of actual to previous day light limiting function */
    },
    "wscal" :
    {
...
/* 9. pft */
  {
    ...
    "bc" : BC4,        /*leaf respiration as fraction of Vmax for C4 plants */
