...
/**                                                                                \n**/
/** Configuration file for LPJmL C Version 5.3.001 with RCP85 climate              \n**/
/**                                                                                \n**/
...
/*===================================================================*/
  ...
  "sim_name" : mkstr(LPJmL run with RCP85 climate and no nitrogen from MODEL), /* Simulation description */
  ...
  "reservoir" : true,
  "wateruse" : "all",  /* other options: "no", "yes", "all" */
#else
  "equilsoil" :  true,
  "population" : false,
  "landuse" : "no",
