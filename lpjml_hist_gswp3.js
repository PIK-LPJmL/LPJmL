...
-------------------------- ---------------------- ----------------------------- */
   ...
   /* { "id" : FPC,              "file" : { "fmt" : RAW, "name" : "../output/gswp3/fpc.bin"}},
    { "id" : MNPP,             "file" : { "fmt" : RAW, "name" : "../output/gswp3/mnpp.bin"}},
    { "id" : MGPP,             "file" : { "fmt" : RAW, "name" : "../output/gswp3/mgpp.bin"}},
    { "id" : MRH,              "file" : { "fmt" : RAW, "name" : "../output/gswp3/mrh.bin"}},
    { "id" : MFAPAR,           "file" : { "fmt" : RAW, "name" : "../output/gswp3/mfapar.bin"}},
    { "id" : MTRANSP,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/mtransp.bin"}},
    { "id" : MRUNOFF,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/mrunoff.bin"}},
    { "id" : MEVAP,            "file" : { "fmt" : RAW, "name" : "../output/gswp3/mevap.bin"}},
    { "id" : MINTERC,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/minterc.bin"}},
    { "id" : MSWC1,            "file" : { "fmt" : RAW, "name" : "../output/gswp3/mswc1.bin"}},
    { "id" : MSWC2,            "file" : { "fmt" : RAW, "name" : "../output/gswp3/mswc2.bin"}},
    ...
    { "id" : MPHEN_TMIN,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/mphen_tmin.bin"}},
    { "id" : MPHEN_TMAX,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/mphen_tmax.bin"}},
    { "id" : MPHEN_LIGHT,      "file" : { "fmt" : RAW, "name" : "../output/gswp3/mphen_light.bin"}},
    { "id" : MPHEN_WATER,      "file" : { "fmt" : RAW, "name" : "../output/gswp3/mphen_water.bin"}},
    ...
    { "id" : MNUPTAKE,         "file" : { "fmt" : RAW, "name" : "../output/gswp3/mnuptake.bin"}},
    { "id" : MLEACHING,        "file" : { "fmt" : RAW, "name" : "../output/gswp3/mleaching.bin"}},
    { "id" : MN2O_DENIT,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/mn2o_denit.bin"}},
    { "id" : MN2O_NIT,         "file" : { "fmt" : RAW, "name" : "../output/gswp3/mn2o_nit.bin"}},
    { "id" : MN2_EMIS,         "file" : { "fmt" : RAW, "name" : "../output/gswp3/mn2_emis.bin"}},
    { "id" : MBNF,             "file" : { "fmt" : RAW, "name" : "../output/gswp3/mbnf.bin"}},
    { "id" : MN_IMMO,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/mn_immo.bin"}},
    { "id" : PFT_NDEMAND,      "file" : { "fmt" : RAW, "name" : "../output/gswp3/pft_ndemand.bin"}},
    { "id" : FIREN,            "file" : { "fmt" : RAW, "name" : "../output/gswp3/firen.bin"}},
    { "id" : MN_MINERALIZATION,"file" : { "fmt" : RAW, "name" : "../output/gswp3/mn_mineralization.bin"}},
    { "id" : MN_VOLATILIZATION,"file" : { "fmt" : RAW, "name" : "../output/gswp3/mn_volatilization.bin"}},
   ...
   /* { "id" : MWATERAMOUNT,     "file" : { "fmt" : RAW, "name" : "../output/gswp3/mwateramount.bin"}},
   ...
   /* { "id" : MALBEDO,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/malbedo.bin"}},
    { "id" : MAXTHAW_DEPTH,    "file" : { "fmt" : RAW, "name" : "../output/gswp3/maxthaw_depth.bin"}},
    { "id" : MSOILTEMP1,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/msoiltemp1.bin"}},
    { "id" : MSOILTEMP2,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/msoiltemp2.bin"}},
    { "id" : MSOILTEMP3,       "file" : { "fmt" : RAW, "name" : "../output/gswp3/msoiltemp3.bin"}},
    ...
    { "id" : MRETURN_FLOW_B,   "file" : { "fmt" : RAW, "name" : "../output/gswp3/mreturn_flow_b.bin"}},
    { "id" : MTRANSP_B,        "file" : { "fmt" : RAW, "name" : "../output/gswp3/mtransp_b.bin"}},
    { "id" : MEVAP_B,          "file" : { "fmt" : RAW, "name" : "../output/gswp3/mevap_b.bin"}},
    { "id" : MINTERC_B,        "file" : { "fmt" : RAW, "name" : "../output/gswp3/mintec_b.bin"}},
    { "id" : ACONV_LOSS_EVAP,  "file" : { "fmt" : RAW, "name" : "../output/gswp3/aconv_loss_evap.bin"}},
    { "id" : ACONV_LOSS_DRAIN, "file" : { "fmt" : RAW, "name" : "../output/gswp3/aconv_loss_drain.bin"}}*/
/*------------------------ ---------------------- ------------------------------- */
  ],
