...
path.out <- paste0("/p/projects/macmit/users/minoli/PROJECTS/CROP_PHENOLOGY_v01/DATA/CROP_CALENDARS/LPJML_INPUT_swheat_only/")
...
verncrops <- c("RAPESEED")    # simulating spring wheat everywhere
...
if (climate_data!="WFDEI") {
  ...
  path.sowing=paste0("/p/projects/macmit/users/minoli/PROJECTS/CROP_PHENOLOGY_v01/DATA/CROP_CALENDARS/LPJML_INPUT_swheat_only/sdate_",climate_data,"_",period,"_",startyear,"_",endyear,".bin")
  path.harvest=paste0("/p/projects/macmit/users/minoli/PROJECTS/CROP_PHENOLOGY_v01/DATA/CROP_CALENDARS/LPJML_INPUT_swheat_only/hdate_",climate_data,"_",period,"_",startyear,"_",endyear,".bin")
