...
/**                                                                                \n**/
/** Configuration file for input dataset for LPJ C Version 5.7.8                   \n**/
/**                                                                                \n**/
...
//  "sdate" : {"fmt" : "clm", "name" : "/p/projects/lpjml/input/historical/input_VERSION2/sdate_combined_filled.clm"}, /* insert prescribed sdate file name here */
  ...
  "temp" :         { "fmt" : "clm",  "name" : "WFDE5_CRU/Tair_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "prec" :         { "fmt" : "clm",  "name" : "WFDE5_CRU/Prec_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "lwdown" :       { "fmt" : "clm",  "name" : "WFDE5_CRU/LWdown_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "swdown" :       { "fmt" : "clm",  "name" : "WFDE5_CRU/SWdown_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "cloud":         { "fmt" : "clm",  "name" : "CRUDATA_TS3_23/cru_ts3.23.1901.2014.cld.dat.clm"},
  "wind":          { "fmt" : "clm",  "name" : "WFDE5_CRU/Wind_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "tmax":          { "fmt" : "clm",  "name" : "WFDE5_CRU/Tmax_WFDE5_CRU_v1.0_daily_lpj.clm"},
  "tmin":          { "fmt" : "clm",  "name" : "WFDE5_CRU/Tmin_WFDE5_CRU_v1.0_daily_lpj.clm"},
  //"lightning" :    { "fmt" : "cdf", "var" : "density", "name" : "/p/projects/biodiversity/oberhagemann/input/wglc_timeseries_30m_daily.nc"},
  "lightning" :    { "fmt" : "clm",  "name" : "input_VERSION2/mlightning.clm"},
  "ignition" :     { "fmt" : "clm",  "name" : "input_VERSION3/prescribed_ignitions_2003_2016.clm"},
  "maxfiresize" : { "fmt" : "cdf", "var" : "maxBA", "name" : "/p/projects/biodiversity/oberhagemann/input/BorealMixedForestTerrainMaxBA.nc"},
  ...
  "humid":         { "fmt" : "clm",  "name" : "WFDE5_CRU/Qair_WFDE5_CRU_v1.0_daily_lpj.clm"}
},
