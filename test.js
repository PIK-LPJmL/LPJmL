...
/**                   l  p  j  m  l  .  j  s                                       \n**/
/**                                                                                \n**/
/** Default configuration file for LPJmL C Version 5.7.9                           \n**/
/**                                                                                \n**/
...
ID                               Fmt                        filename
-------------------------------- ------------------------- ----------------------------- */
    { "id" : "grid",             "file" : { "fmt" : "raw", "metafile" : true, "name" : "output/grid.bin" }},
...
/*===================================================================*/
  ...
  "startgrid" : 27410, /* 27410, 67208 60400 47284 47293 47277 all grid cells */
#ifdef CHECKPOINT
  ...
  "nspinyear" : 30,  /* cycle length during spinup (yr)*/
  "firstyear": 1901, /* first year of simulation */
  "lastyear" : 1903, /* last year of simulation */
