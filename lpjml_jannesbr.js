...
-------------------------------- ------------------------- ----------------------------- */
    ...
    { "id" : "npp",              "file" : { "fmt" : "raw", "name" : "output/npp.bin"}},
    { "id" : "gpp",              "file" : { "fmt" : "raw", "name" : "output/gpp.bin"}},
    { "id" : "rh",               "file" : { "fmt" : "raw", "name" : "output/rh.bin"}},
    { "id" : "transp",           "file" : { "fmt" : "raw", "name" : "output/transp.bin"}},
    { "id" : "runoff",           "file" : { "fmt" : "raw", "name" : "output/runoff.bin"}},
    { "id" : "evap",             "file" : { "fmt" : "raw", "name" : "output/evap.bin"}},
    { "id" : "prec",             "file" : { "fmt" : "raw", "name" : "output/prec.bin"}},
    { "id" : "irrig",             "file" : { "fmt" : "raw", "name" : "output/irrig.bin"}},
    { "id" : "interc",           "file" : { "fmt" : "raw", "name" : "output/interc.bin"}},
    { "id" : "firef",            "file" : { "fmt" : "raw", "name" : "output/firef.bin"}},
    { "id" : "vegc",             "file" : { "fmt" : "raw", "name" : "output/vegc.bin"}},
    { "id" : "temp",             "file" : { "fmt" : "raw", "timestep": "annual", "name" : "output/temp.bin"}},
    ...
    { "id" : "nuptake",          "file" : { "fmt" : "raw", "name" : "output/nuptake.bin"}},
    { "id" : "leaching",         "file" : { "fmt" : "raw", "name" : "output/leaching.bin"}},
    { "id" : "n2o_denit",        "file" : { "fmt" : "raw", "name" : "output/n2o_denit.bin"}},
    { "id" : "n2o_nit",          "file" : { "fmt" : "raw", "name" : "output/n2o_nit.bin"}},
    { "id" : "n2_emis",          "file" : { "fmt" : "raw", "name" : "output/n2_emis.bin"}},
    { "id" : "bnf",              "file" : { "fmt" : "raw", "name" : "output/bnf.bin"}},
    { "id" : "n_immo",           "file" : { "fmt" : "raw", "name" : "output/n_immo.bin"}},
    { "id" : "pft_ndemand",      "file" : { "fmt" : "raw", "name" : "output/pft_ndemand.bin"}},
    { "id" : "n_mineralization", "file" : { "fmt" : "raw", "name" : "output/n_mineralization.bin"}},
    { "id" : "n_volatilization", "file" : { "fmt" : "raw", "name" : "output/n_volatilization.bin"}},
    ...
    { "id" : "nfire",            "file" : { "fmt" : "raw", "name" : "output/nfire.bin"}},
    { "id" : "burntarea",        "file" : { "fmt" : "raw", "name" : "output/burnt_area.bin"}},
#else
    { "id" : "firec",            "file" : { "fmt" : "raw", "name" : "output/firec.bin"}},
#endif
    { "id" : "discharge",        "file" : { "fmt" : "raw", "name" : "output/discharge.bin"}},
    { "id" : "wateramount",      "file" : { "fmt" : "raw", "name" : "output/wateramount.bin"}},
    { "id" : "harvestc",         "file" : { "fmt" : "raw", "name" : "output/flux_harvest.bin"}},
    { "id" : "hdate",            "file" : { "fmt" : "raw", "name" : "output/hdate.bin"}},
    ...
    { "id" : "pet",              "file" : { "fmt" : "raw", "name" : "output/pet.bin"}},
    { "id" : "albedo",           "file" : { "fmt" : "raw", "name" : "output/albedo.bin"}},
    { "id" : "perc",             "file" : { "fmt" : "raw", "name" : "output/perc.bin"}},
    { "id" : "swc",              "file" : { "fmt" : "raw", "name" : "output/swc.bin"}},
    { "id" : "soilc_layer",      "file" : { "fmt" : "raw", "name" : "output/soilc_layer.bin"}},
    { "id" : "return_flow_b",    "file" : { "fmt" : "raw", "name" : "output/return_flow_b.bin"}},
    { "id" : "transp_b",         "file" : { "fmt" : "raw", "name" : "output/transp_b.bin"}},
    { "id" : "evap_b",           "file" : { "fmt" : "raw", "name" : "output/evap_b.bin"}},
    { "id" : "interc_b",         "file" : { "fmt" : "raw", "name" : "output/intec_b.bin"}},
    { "id" : "prod_turnover",    "file" : { "fmt" : "raw", "name" : "output/prod_turnover.bin"}},
    { "id" : "deforest_emis",    "file" : { "fmt" : "raw", "name" : "output/deforest_emis.bin"}},
    { "id" : "conv_loss_evap",   "file" : { "fmt" : "raw", "name" : "output/conv_loss_evap.bin"}},
    { "id" : "conv_loss_drain",  "file" : { "fmt" : "raw", "name" : "output/conv_loss_drain.bin"}}
/*------------------------------ ------------------------- ------------------------------- */
  ],
