...
"input" :
{
  ...
  "temp" :         { "fmt" : CLM,  "name" : "input_VERSION2/cru_ts3.23.1901.2014.tmp.dat.clm"},
  "prec" :         { "fmt" : CLM,  "name" : "input_VERSION2/gpcc_v7_cruts3_23_precip_1901_2013.clm"},
  ...
  "cloud":         { "fmt" : CLM,  "name" : "input_VERSION2/cru_ts3.23.1901.2014.cld.dat.clm"},
  "wind":          { "fmt" : CLM,  "name" : "input_VERSION2/mwindspeed_1860-2100_67420.clm"},
  "tamp":          { "fmt" : CLM,  "name" : "input_VERSION2/cru_ts3.23.1901.2014.dtr.dat.clm"}, /* diurnal temp. range */
  ...
  "burntarea" :    { "fmt" : CLM,  "name" : "/mnt/biosx/mforkel/input_new/GFED_CNFDB_ALFDB_Interp.BA.360.720.1901.2012.30days.clm"},
  "landcover":     { "fmt" : CLM,  "name" : "/mnt/biosx/mforkel/input_new/landcover_synmap_koeppen_vcf_newPFT_forLPJ_20130910.clm"},/*synmap_koeppen_vcf_NewPFT_adjustedByLanduse_SpinupTransitionPrescribed_forLPJ.clm*/
  "co2" :          { "fmt" : TXT,  "name" : "input_VERSION2/co2_1841-2012.dat"},
  "wetdays" :      { "fmt" : CLM,  "name" : "input_VERSION2/gpcc_v7_cruts3_23_wet_1901_2013.clm"},
