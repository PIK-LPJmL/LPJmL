...
#else
  biofuel=0;
  pft->stand->cell->ml.product.fast.nitrogen+=harvest.nitrogen*f.fast*standfrac;
  pft->stand->cell->ml.product.slow.nitrogen+=harvest.nitrogen*f.slow*standfrac;
  pft->stand->cell->ml.product.fast.carbon+=harvest.carbon*f.fast*standfrac;
  pft->stand->cell->ml.product.slow.carbon+=harvest.carbon*f.slow*standfrac;
#endif
