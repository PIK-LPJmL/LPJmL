/**************************************************************************************/
/**                                                                                \n**/
/**           b  s  t  r  u  c  t  _  r  e  a  d  d  o  u  b  l  e  .  c           \n**/
/**                                                                                \n**/
...
Bool bstruct_readdouble(Bstruct bstr,     /**< pointer to restart file */
                        const char *name, /**< name of object or NULL */
                        double *value     /**< value read from file */
                       )                  /** \return TRUE on error */
{
  Byte token;
  if(bstruct_readtoken(bstr,&token,BSTRUCT_DOUBLE,name))
    return TRUE;
