                            ...
                            )
{
  ...
  crop=pft->data;
  livefuel_consum.carbon = livefuel_consum_total.carbon=fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.leaf.carbon*pft->nind;
  livefuel_consum.nitrogen = livefuel_consum_total.nitrogen=fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.leaf.nitrogen*pft->nind;
  /* livegrass update */
  if (pft->nind > 0)
  {
  ...
  livefuel_consum.carbon = fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.so.carbon*pft->nind;
  livefuel_consum.nitrogen = fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.so.nitrogen*pft->nind;
  if (pft->nind > 0)
  {
  ...
  livefuel_consum.carbon = fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.pool.carbon*pft->nind;
  livefuel_consum.nitrogen = fuel_consumption_1hr(livefuel->dlm_livegrass,fire_frac)*crop->ind.pool.nitrogen*pft->nind;
  if (pft->nind > 0)
  {
