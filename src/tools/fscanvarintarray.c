/**************************************************************************************/
/**                                                                                \n**/
/**                   f  s  c  a  n  v  a  r  i  n  t  a  r  r  a  y  .  c         \n**/
/**                                                                                \n**/
/**     C implementation of LPJmL                                                  \n**/
/**                                                                                \n**/
/**     Function reads an int array from a LPJ file                                \n**/
/**                                                                                \n**/
...
int *fscanvarintarray(LPJfile *file,    /**< pointer to LPJ file */
                      int *size,        /**< size of array */
                      const char *key,  /**< name of array */
                      Verbosity verb    /**< verbosity level (NO_ERR,ERR,VERB) */
                     )                  /** \return int array read or NULL on error */
{
  int *vec;
  int i;
  ...
  *size=json_object_array_length(array);
  ...
  for(i=0;i<*size;i++)
  {
    ...
    vec[i]=json_object_get_int(item);
    if (verb >= VERB)
    {
      printf(" %d",vec[i]);
      if(i<*size-1)
