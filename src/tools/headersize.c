...
const size_t typesizes[]={1,sizeof(short),sizeof(int),sizeof(float),sizeof(double),1,sizeof(unsigned short),0};
char *typenames[]={"byte","short","int","float","double","bool","ushort","zero","string","array","struct","endstruct","endarray"};
