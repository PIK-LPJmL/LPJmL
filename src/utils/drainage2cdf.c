...
#define USAGE "Usage: %s [-var name] [-config file] soilcode.nc grid.clm drainage.clm drainage.nc\n"
...
int main(int argc,char **argv)
{
  ...
  error(rc);
  rc=nc_def_var(ncid,config.lat.name,NC_FLOAT,1,&lat_dim_id,&lat_var_id);
  error(rc);
