                    ...
                    )                /** \return vmax (gC/m2/day) */
{
  ...
  vmax=(pft->nleaf-pft->par->ncleaf.low*(grass->ind.leaf.carbon*pft->nind+pft->bm_inc.carbon*grass->falloc.leaf-grass->turn_litt.leaf.carbon))/exp(66530/8.314*(1/degCtoK(temp)-1/degCtoK(25)))/0.010*(NSECONDSDAY*cmass*1e-6);
