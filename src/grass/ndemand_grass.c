                 ...
                 )                    /** \return total N demand  (gN/m2) */
{
  ...
  *ndemand_leaf=0.010*vmax/(NSECONDSDAY*cmass*1e-6)*exp(66530/8.314*(1/degCtoK(temp)-1/degCtoK(25))) + pft->par->ncleaf.low*(grass->ind.leaf.carbon*pft->nind+pft->bm_inc.carbon*grass->falloc.leaf-grass->turn_litt.leaf.carbon);
