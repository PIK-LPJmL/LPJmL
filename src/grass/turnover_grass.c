                     ...
                     )                /** \return turnover (gC/m2,gN/m2) */
{
  ...
  if(fabs(end-start.carbon)>0.0001)
    fail(INVALID_CARBON_BALANCE_ERR,FAIL_ON_BALANCE,TRUE,"Invalid carbon balance in turnover grass(): landusetype %s : %g start : %g end : %g  bm_inc.carbon: %g  bminc_old: %g  PFT:%s nind: %g leaf_turn_litt: %g root_turn_litt: %g  root_turn: %g"
         "  leaf_turn: %g reprod: %g litter_old: %g  litter: %g est.carbon: %g est.carbon_old: %g fraction: %g vegsum: %g vegsum_old: %g excess_carbon: %g excess_carbon_old: %g",
  ...
  if(fabs(end-start.nitrogen)>0.00001)
    fail(INVALID_NITROGEN_BALANCE_ERR,FAIL_ON_BALANCE,TRUE,"Invalid nitrogen balance in turnover grass(): landusetype %s : %g start : %g end : %g  bm_inc.nitrogen: %g  bminc_old: %g  PFT:%s nind: %g leaf_turn_litt: %g root_turn_litt: %g  root_turn: %g"
         "  leaf_turn: %g reprod: %g litter_old: %g  litter: %g est.nitrogen: %g est.nitrogen_old: %g fraction: %g vegsum: %g",
