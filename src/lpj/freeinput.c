              ...
              )
{
  ...
  freerealdata(input.hdi,isroot(*config));
  freerealdata(input.conifer,isroot(*config));
  freerealdata(input.drypine,isroot(*config));
  freerealdata(input.nonnativebl,isroot(*config));
  freerealdata(input.tpi,isroot(*config));
  freerealdata(input.slope,isroot(*config));
  //freerealdata(input.popdens,isroot(*config));
