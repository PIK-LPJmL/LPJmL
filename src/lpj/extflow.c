                   ...
                   )                     /** \return pointer to extflow data or NULL on errir */
{
  ...
  if(config->extflow_filename.fmt==META)
  {
    ...
    extflow->file=openmetafile(&header,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,&extflow->swap,&offset,config->extflow_filename.name,isroot(*config));
