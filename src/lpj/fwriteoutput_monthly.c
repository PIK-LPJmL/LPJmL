                         ...
                         )
{
  ...
  writeoutputvar(MNUPTAKE,mn_uptake);
  writeoutputvar(MLEACHING,mn_leaching);
  writeoutputvar(MN2O_DENIT,mn2o_denit);
  writeoutputvar(MN2O_NIT,mn2o_nit);
  writeoutputvar(MN2_EMIS,mn2_emissions);
  writeoutputvar(MBNF,mbnf);
  writeoutputvar(MN_MINERALIZATION,mn_mineralization);
  writeoutputvar(MN_VOLATILIZATION,mn_volatilization);
  writeoutputvar(MN_IMMO,mn_immo);
