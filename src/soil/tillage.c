...
void tillage(Soil *soil, Real frac)
{
  int i,l;
  ...
  for (l = 0; l < soil->litter.n; l++)
  {
    ...
    if (soil->litter.item[l].ag.leaf.carbon < epsilon) soil->litter.item[l].ag.leaf.carbon = 0;
    ...
    if (soil->litter.item[l].ag.leaf.nitrogen < epsilon) soil->litter.item[l].ag.leaf.nitrogen = 0;
    ...
    if (soil->litter.item[l].ag.wood[i].carbon < epsilon) soil->litter.item[l].ag.wood[i].carbon = 0;
    ...
    if (soil->litter.item[l].ag.wood[i].nitrogen < epsilon) soil->litter.item[l].ag.wood[i].nitrogen = 0;
    }
  }
