...
void product_turnover(Cell *cell)
{
  ...
  cell->balance.prod_turnover.carbon+=cell->ml.product.fast.carbon*PRODUCT_FAST;
  cell->balance.prod_turnover.carbon+=cell->ml.product.slow.carbon*PRODUCT_SLOW;
  ...
  cell->balance.prod_turnover.nitrogen+=cell->ml.product.fast.nitrogen*PRODUCT_FAST;
  cell->balance.prod_turnover.nitrogen+=cell->ml.product.slow.nitrogen*PRODUCT_SLOW;
