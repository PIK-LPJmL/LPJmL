...
/**                   l  p  j  m  l  .  j  s                                       \n**/
/**                                                                                \n**/
/** Default configuration file for LPJmL C Version 5.7.10                           \n**/
/**                                                                                \n**/
...
-------------------------------- ------------------------- ----------------------------- */
    ...
    { "id" : "nfert_mg",     "file" : { "fmt" : "raw", "name" : "output/nfert_mg.bin"}},
    ...
    { "id" : "bnf_agr",          "file" : { "fmt" : "raw", "name" : "output/bnf_agr.bin"}},
    { "id" : "bnf_mg",           "file" : { "fmt" : "raw", "name" : "output/bnf_mg.bin"}},
    { "id" : "nfert_agr",        "file" : { "fmt" : "raw", "name" : "output/nfert_agr.bin"}},
    { "id" : "nmanure_agr",      "file" : { "fmt" : "raw", "name" : "output/nmanure_agr.bin"}},
    { "id" : "ndepo_agr",        "file" : { "fmt" : "raw", "name" : "output/ndepo_agr.bin"}},
    { "id" : "ndepo_mg",         "file" : { "fmt" : "raw", "name" : "output/ndepo_mg.bin"}},
    { "id" : "nmineralization_agr", "file" : { "fmt" : "raw", "name" : "output/nmineralization_agr.bin"}},
    { "id" : "nimmobilization_agr", "file" : { "fmt" : "raw", "name" : "output/nimmobilization_agr.bin"}},
    { "id" : "nuptake_agr",      "file" : { "fmt" : "raw", "name" : "output/nuptake_agr.bin"}},
    { "id" : "nleaching_agr",    "file" : { "fmt" : "raw", "name" : "output/nleaching_agr.bin"}},
    { "id" : "n2o_denit_agr",    "file" : { "fmt" : "raw", "name" : "output/n2o_denit_agr.bin"}},
    { "id" : "n2o_nit_agr",      "file" : { "fmt" : "raw", "name" : "output/n2o_nit_agr.bin"}},
    { "id" : "nh3_agr",          "file" : { "fmt" : "raw", "name" : "output/nh3_agr.bin"}},
    { "id" : "n2_agr",           "file" : { "fmt" : "raw", "name" : "output/n2_agr.bin"}},
    { "id" : "harvestn_agr",     "file" : { "fmt" : "raw", "name" : "output/harvestn_agr.bin"}},
    { "id" : "harvestc_agr",     "file" : { "fmt" : "raw", "name" : "output/harvestc_agr.bin"}},
    { "id" : "seedn_agr",        "file" : { "fmt" : "raw", "name" : "output/seedn_agr.bin"}},
    { "id" : "cellfrac_agr",     "file" : { "fmt" : "raw", "name" : "output/cellfrac_agr.bin"}},
    { "id" : "litfalln_agr",     "file" : { "fmt" : "raw", "name" : "output/litfalln_agr.bin"}},
    { "id" : "rootmoist",        "file" : { "fmt" : "raw", "name" : "output/rootmoist.bin"}},
    { "id" : "uptakec_mgrass",   "file" : { "fmt" : "raw", "name" : "output/uptakec_mgrass.bin"}},
    { "id" : "yieldn_mgrass",    "file" : { "fmt" : "raw", "name" : "output/yieldn_mgrass.bin"}},
    { "id" : "no3_leaching_mgrass", "file" : { "fmt" : "raw", "name" : "output/no3_leaching_mgrass.bin"}},
    { "id" : "n2o_nit_mgrass",   "file" : { "fmt" : "raw", "name" : "output/n2o_nit_mgrass.bin"}},
    { "id" : "n2o_denit_mgrass", "file" : { "fmt" : "raw", "name" : "output/n2o_denit_mgrass.bin"}},
    { "id" : "n2_mgrass",        "file" : { "fmt" : "raw", "name" : "output/n2_mgrass.bin"}},
    { "id" : "nh3_mgrass",       "file" : { "fmt" : "raw", "name" : "output/nh3_mgrass.bin"}},
    { "id" : "irrig",         "file" : { "fmt" : "raw", "name" : "output/irrig.bin"}},
    { "id" : "harvestn",         "file" : { "fmt" : "raw", "name" : "output/flux_harvestn.bin"}},
    { "id" : "flux_estabn_mg","file" : { "fmt" : "raw", "name" : "output/flux_estabn_mg.bin"}},
    { "id" : "pft_npp",          "file" : { "fmt" : "raw", "name" : "output/pft_npp.bin"}},
    { "id" : "timber_harvestc",          "file" : { "fmt" : "raw", "name" : "output/timber_harvestc.bin"}},
    { "id" : "prec",          "file" : { "fmt" : "raw", "name" : "output/prec.bin"}},
    { "id" : "temp",          "file" : { "fmt" : "raw", "name" : "output/temp.bin"}}
/*------------------------------ ------------------------- ------------------------------- */
  ],
