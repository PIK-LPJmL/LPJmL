...
/**                   l  p  j  m  l  .  j  s                                       \n**/
/**                                                                                \n**/
/** Default configuration file for LPJmL C Version 5.7.2                           \n**/
/**                                                                                \n**/
...
-------------------------------- ------------------------- ----------------------------- */
    ...
    { "id" : "swc",              "file" : { "fmt" : "raw", "name" : "output/mswc.bin"}},
    { "id" : "rootmoist",        "file" : { "fmt" : "raw", "name" : "output/rootmoist.bin"}},
    { "id" : "prec",             "file" : { "fmt" : "raw", "name" : "output/mprec.bin"}},
    ...
    { "id" : "pft_lai",       "file" : { "fmt" : "raw", "name" : "output/pft_lai.bin"}},
    ...
    { "id" : "fpc_bft",          "file" : { "fmt" : "raw", "name" : "output/fpc_bft.bin" }},
    ...
    { "id" : "pft_rharvestc",    "file" : { "fmt" : "raw", "name" : mkstr(output/pft_rharvest.SUFFIX)}},
    ...
    { "id" : "irrig",            "file" : { "fmt" : "raw", "name" : "output/mirrig.bin"}},
    { "id" : "harvestn",         "file" : { "fmt" : "raw", "name" : "output/harvestn.bin"}},
    { "id" : "pft_harvestn",     "file" : { "fmt" : "raw", "name" : mkstr(output/pft_harvestn.SUFFIX)}},
    { "id" : "pft_rharvestn",    "file" : { "fmt" : "raw", "name" : mkstr(output/pft_rharvestn.SUFFIX)}},
    ...
    { "id" : "mg_vegc",          "file" : { "fmt" : "raw", "name" : "output/mg_vegc.bin"}},
    { "id" : "mg_soilc",          "file" : { "fmt" : "raw", "name" : "output/mg_soilc.bin"}},
    { "id" : "mg_litc",          "file" : { "fmt" : "raw", "name" : "output/mg_litc.bin"}},
