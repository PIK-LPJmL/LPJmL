...
typedef struct
{
  ...
  Real nfrac_grassharvest; /**< fraction of nitrogen from grass harvest not returned to NH4 pool via manure, Mowing: application after harvest Grazing: daily application*/
} Param;
