...
#define TROPICAL_BROADLEAVED_EVERGREEN_TREE_FLOODTOLERANT 1
#define TROPICAL_BROADLEAVED_RAINGREEN_TREE 2
#define TEMPERATE_NEEDLELEAVED_EVERGREEN_TREE 3
#define TEMPERATE_BROADLEAVED_EVERGREEN_TREE 4
#define TEMPERATE_BROADLEAVED_SUMMERGREEN_TREE 5
#define BOREAL_NEEDLELEAVED_EVERGREEN_TREE 6
#define BOREAL_BROADLEAVED_SUMMERGREEN_TREE 7
#define BOREAL_NEEDLELEAVED_SUMMERGREEN_TREE 8
