...
struct standtype
{
  ...
  void (*dailyfire)(Stand *,Real,Real,const Dailyclimate *,const Config *);
...
#define dailyfire_stand(stand,popdens,avgprec,climate,config) if(stand->type->dailyfire!=NULL) stand->type->dailyfire(stand,popdens,avgprec,climate,config)
