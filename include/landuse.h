...
extern Bool fwritelandfrac(FILE *,const char *,const Landfrac [2],int,int);
extern void fprintlandfrac(FILE *,const Landfrac *,int,int);
extern Bool freadlandfrac(FILE *,const char *,Landfrac [2],int,int,Bool);
...
extern Bool fwrite_irrigation(FILE *,const char *,const Irrigation *);
extern void fprint_irrigation(FILE *,const Irrigation *,const Pftpar *);
extern Bool fread_irrigation(FILE *,const char *,Irrigation *,Bool);
