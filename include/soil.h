...
#define c_albedo_bare_soil  0.31 /* albedo of the bare soil as used by Gascoin et al 2009 in moisture dependent albedo function */
...
extern void pftlitter_agtop(Real *,const Litter *);
...
extern Real litter_agtop_crop(const Litter *);
