...
extern Bool freadlitter(FILE *,const char *,Litter *,const struct Pftpar *,int,Bool);
extern Bool freadsoil(FILE *,const char *,Soil *,const Soilpar *,const struct Pftpar *,int,Bool);
...
extern Bool fwritesoil(FILE *,const char *,const Soil *,int);
extern Bool fwritelitter(FILE *,const char *,const Litter *);
